...
const docs = [
  {
    ...
    phrases: [
      ...
      "LAEL_PUBLIC_DEMO_ITERATION_TEST_REPORT_2026-06-18.zh.md",
  ...
  {
    path: "docs/LAEL_PUBLIC_DEMO_ITERATION_TEST_REPORT_2026-06-18.zh.md",
    phrases: [
      "Public Demo 发布后迭代、测试与修复报告",
  ...
  },
  {
    ...
    phrases: ["项目迭代过程记录", "v0.1 / v0.2", "统一 Runtime Fabric", "Microsoft AGT 融合", "多链钱包支持", "链上验收强化", "June 15 交付轨道", "Wallet Demo 脚本", "真实环境测试报告", "内部技术一页纸", "NEXT_SESSION_HANDOFF.md", "Cloudflare quick tunnel", "/v2/runtime-config", "Public Demo 发布后迭代、测试与修复", "LAEL_PUBLIC_DEMO_ITERATION_TEST_REPORT_2026-06-18.zh.md"],
  },
  {
